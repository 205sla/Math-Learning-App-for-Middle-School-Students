...
public class MoveManager : MonoBehaviour
{
    ...
    void problemEnd()//문제 다 풀었어요
    {
        ...
        //page.DoLa
        */
        page.transform.DOLocalMove(new Vector3(-1080 * 3 * 2, 0, 0), 1.0f).SetEase(Ease.OutBounce);
        Debug.Log("문제 다 풀었어요");
        Progress = "결과창";
    ...
    public void GoTitle()
    {
        page.transform.DOLocalMove(new Vector3(-1080 * 4 * 2, 0, 0), 2.0f).SetEase(Ease.OutBounce).OnComplete(() =>
        {
    ...
    {
        if(Progress== "문제 코스 고르기")
        {
            StudyCos = cos;
            page.transform.DOLocalMove(new Vector3(-1080 * 2 * 2, 0, 0), 1.0f).SetEase(Ease.OutBounce);
            Progress = "문제출제시작";
        }
